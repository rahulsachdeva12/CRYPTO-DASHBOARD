            ...
            Price: {
                options: {
                    ...
                    grid: {
                        ...
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: "orange"
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
            ...
            ,Market_Cap: {
                options: {
                    ...
                    grid: {
                        ...
                        text: "Market Cap (INR)",
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: 'green', 
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
            ...
            Tot_Vol: {
                options: {
                    grid: {
                        ...
                        text: "Market Volume",
                        style: {
                            fontSize: '14px', fontWeight: 'bold', color: "yellow"
                        }
                    }, stroke: {
                        curve: 'smooth'
                    }, xaxis: {
                    ...
                    <div className="row">
                        ...
                        <div className="col" style={{ maxWidth: '200px' }}>
                            ...
                            <div className="card-body ">
                                <h6 className="card-title" style={{color:"red" }}> Market Cap </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: 'rgb(255,255,255)', fontSize: 'small' }}>
                                    ₹ {this.props.MarketCap}
                                </p>
                            </div>
                            <br/>
                            <div className="card-body ">
                                <h6 className="card-title" style={{ color:"red" }}>Offical Website</h6>
                                <p className="card-text fw-bold "
                                    style={{  color: 'rgb(255,255,255)' ,fontSize: 'small' }}>
                            ...
                            <br/>
                            <div className="card-body ">
                                <h6 className="card-title" style={{ color:"red"}}> Price Change 24hrs </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: 'rgb(255,255,255)', fontSize: 'small' }}>
                            ...
                            <br/>
                            <div className="card-body ">
                                <h6 className="card-title" style={{ color:"red" }}> Total Volume </h6>
                                <p className="card-text fw-bold "
                                    style={{  color: 'rgb(255,255,255)', fontSize: 'small' }}>
                                    ₹ {this.props.TotVol}
                                </p>
                            ...
                            <br/>
                            <div className="card-body ">
                                <h6 className="card-title" style={{ color:"red" }}> Circulating Supply</h6>
                                <p className="card-text fw-bold "
                                    style={{  color: 'rgb(255,255,255)', fontSize: 'small' }}>
                            ...
                            <br/>
                            <div className="card-body ">
                                <h6 className="card-title" style={{ color:"red" }}> Twitter Followers</h6>
                                <p className="card-text fw-bold "
                                    style={{  color: 'rgb(255, 255, 255)', fontSize: 'small' }}>
                                    {this.props.twitterF}
                                </p>
